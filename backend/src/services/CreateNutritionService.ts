    ...
    async execute({ name, weight, height, age, gender, objective, level }: DataProps){
        try {
            ...
            const response = await model.generateContent(`
                ...
                uma refeição da dieta e dentro de cada refeição a propriedade horário com horário da refeição, 
                propriedade nome com nome e a propriedade alimentos com array contendo os alimentos 
